...
package samples.download.taskmanager.events
{
    ...
    public class TaskProgressEvent extends Event
    {
        ...
        public static const TASK_PROGRESS_CHANGED:String = "TASK_PROGRESS_CHANGED";
        
        public var task:Task;
        public var handle:ProgressHandle;
        
        public function TaskProgressEvent(type:String, task:Task, handle:ProgressHandle)
        {
            super(type, false);
            this.task = task
            this.handle = handle;
