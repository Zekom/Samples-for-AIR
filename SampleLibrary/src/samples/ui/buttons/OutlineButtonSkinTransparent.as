...
package samples.ui.buttons
{
	...
	/**
	 * Provides skin for button
	 */ 
	public class OutlineButtonSkinTransparent extends OutlineButtonSkinBlack
	{
		[Embed(source="/../assets/images/Back_frame.png", scaleGridTop="4", scaleGridBottom="5", scaleGridLeft="4", scaleGridRight="5")]
        public static var ButtonSkinUp:Class;
		
		public function OutlineButtonSkinTransparent()
		{
			super();
		}
		...
		{
			upSkin = new ButtonSkinUp();
			setSkinState(SkinStates.UP, upSkin );
			
			downSkin = new SkinAssets.BackButtonPressedBlack();
			setSkinState(SkinStates.DOWN,downSkin);
			
			setSkinState( SkinStates.SELECTED, downSkin );
			
			disabledSkin = new SkinAssets.BackButtonDisabledBlack();
